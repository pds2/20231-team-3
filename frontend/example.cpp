...
int main() {
    ...
    CROW_ROUTE(app, "/")
        ...
        ([]() {
        // Abre o arquivo HTML
        std::ifstream t("frontend/routes/index.html");
        if (!t.is_open()) {
    ...
    CROW_ROUTE(app,"/sobre")
        ...
        ([]{
        // Abre o arquivo HTML
        std::ifstream t("frontend/routes/sobre.html");
        if (!t.is_open()) {
        // Se ocorrer algum erro ao abrir o arquivo, retorne uma resposta de erro
    ...
    CROW_ROUTE(app,"/categoria/acao")
        ...
        ([]{
            // Abre o arquivo HTML
        std::ifstream t("frontend/routes/pag_acao.html");
        if (!t.is_open()) {
        // Se ocorrer algum erro ao abrir o arquivo, retorne uma resposta de erro
        return crow::response(500, "Erro ao abrir o arquivo livro HTML");
        }
    ...
    CROW_ROUTE(app, "/livros")
        ...
        ([]() {
        // Abre o arquivo HTML
        std::ifstream t("frontend/routes/pag_livro.html");
        if (!t.is_open()) {
        // Se ocorrer algum erro ao abrir o arquivo, retorne uma resposta de erro
        return crow::response(500, "Erro ao abrir o arquivo livro HTML");
        }
    ...
    CROW_ROUTE(app, "/categoria/romance")
        ...
        ([]() {
        // Abre o arquivo HTML
        std::ifstream t("frontend/routes/pag_romance.html");
        if (!t.is_open()) {
        // Se ocorrer algum erro ao abrir o arquivo, retorne uma resposta de erro
        return crow::response(500, "Erro ao abrir o arquivo HTML");
        }
    ...
    CROW_ROUTE(app, "/categoria/suspense")
        .name("categoria/suspense")
            ([]() {
            // Abre o arquivo HTML
            std::ifstream t("frontend/routes/pag_suspense.html");
            if (!t.is_open()) {
            // Se ocorrer algum erro ao abrir o arquivo, retorne uma resposta de erro
            return crow::response(500, "Erro ao abrir o arquivo HTML");
            }
